...
public class RedisPropertyTests {
    ...
    void testSetHost() {
        ...
        // WHEN - Call the setHost method with the new host
        redisProperty.setHost(newHost);
        // THEN - Assert that the host property is updated to the new host
    ...
    void testSetPort() {
        // GIVEN - Initialize the port property
        int newPort = 8080;
        // WHEN - Call the setPort method with the new port
        redisProperty.setPort(newPort);
        // THEN - Assert that the port property is updated to the new port
    ...
    void testSetPassword() {
        ...
        // THEN - Assert that the password property is updated to the new password
