package com/bestpractice/api/common/exception/ConflictTests;
...
public class ConflictTests {
    ...
    void testConflictString() {
        // GIVEN - String message = "This is a conflict";
        // WHEN - Conflict conflict = new Conflict(message);
        // THEN - assertEquals(message, conflict.getMessage());
    }
    ...
    void testConflictStringThrowable() {
        ...
        // WHEN - Conflict conflict = new Conflict(message, cause);
        // THEN - assertEquals(message, conflict.getMessage());
