...
public class LocalUserPersistentRepositoryGeneratedAiTests {
    ...
    void testInsert_NewUser() {
        User newUser = new User("3", "newuser", "new@example.com", "password");
    ...
    @Test
    void testReplace_ExistingUser() {
        repository.insert(new User("4", "existinguser", "existing@example.com", "password"));
        User updatedUser = new User("4", "updateduser", "updated@example.com", "newpassword");
    ...
    void testRemoveById_ExistingUser() {
        repository.insert(new User("5", "removeuser", "remove@example.com", "password"));
