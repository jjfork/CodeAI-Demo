...
class CredentialTests {
    ...
    void testGetTokenType() {
        ...
        // THEN - The retrieved token type should be equal to the token type used in the constructor.
    ...
    void testGetExp() {
        ...
        // THEN - The retrieved expiration date should be equal to the expiration date used in the constructor.
    ...
    void testIsRefresh() {
        ...
        // THEN - The retrieved refresh status should be equal to the refresh status used in the constructor.
