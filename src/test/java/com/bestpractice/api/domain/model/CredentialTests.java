...
class CredentialTests {
    ...
    void testGetToken() {
        ...
        // THEN - The retrieved token should be equal to the initial token value.
    ...
    void testGetTokenType() {
        ...
        // THEN - The retrieved token type should be equal to the initial token type value.
    ...
    void testGetExp() {
        ...
        // THEN - The retrieved expiration date should be equal to the initial expiration date value.
    ...
    void testIsRefresh() {
        ...
        // THEN - The retrieved refresh status should be equal to the initial refresh value.
