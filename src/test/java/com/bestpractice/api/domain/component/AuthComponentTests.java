...
class CredentialTests {
    ...
    void testGetToken() {
        ...
        // THEN - The returned token should be equal to the token set in the constructor.
    ...
    void testGetTokenType() {
        ...
        // THEN - The returned tokenType should be equal to the tokenType set in the constructor.
    ...
    void testGetExp() {
        ...
        // THEN - The returned exp should be equal to the exp set in the constructor.
    ...
    void testIsRefresh() {
        ...
        // THEN - The returned isRefresh should be equal to the isRefresh set in the constructor.
